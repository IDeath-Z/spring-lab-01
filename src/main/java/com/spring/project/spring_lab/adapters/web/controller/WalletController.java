...
public class WalletController {
    ...
    @PatchMapping("/set-default/{walletId}")
    public ResponseEntity<?> setDefaultWallet(@PathVariable UUID walletId) {

        return ResponseEntity.status(HttpStatus.OK).body(walletService.switchDefaultWallet(walletId));
    }
